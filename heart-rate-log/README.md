...
This is **Phase 1 + 2 + 3** of the plan: manual logging with a browsable/editable history
grid, photo/file attachments (Phase 2), and a Chart tab plotting any metric over time,
color-coded by a second metric (Phase 3). Pulling real heart-rate readings from Fitbit
(Phase 4) comes next.
